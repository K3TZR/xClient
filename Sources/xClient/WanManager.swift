...
public final class WanManager: WanServerDelegate {
    ...
    /// Given a Refresh Token attempt to get an Id Token
    /// - Parameter refreshToken:         a Refresh Token
    /// - Returns:                        an Id Token (if any)
    ///
    ...
    // ----------------------------------------------------------------------------
    // MARK: - SmartlinkAuthorizationView methods
    
    /// Receives the ID and Refresh token from the SmartlinkAuthorizationView login
    /// - Parameters:
    ///   - idToken:        id Token string
    ///   - refreshToken:   refresh Token string
    ///
    func processAuthorizationTokens(idToken: IdToken, refreshToken: String) {
        if isValidIdToken(idToken) {
    ...
    /// Close the SmartlinkAuthorizationView sheet
    ///
    func closeSmartlinkAuthorizationView() {
